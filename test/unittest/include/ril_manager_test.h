...
public:
    ...
    const int32_t HRIL_ADAPTER_RADIO_INDICATION = 2001;
    const int32_t HRIL_ADAPTER_RADIO_RESPONSE = 2002;
    const int32_t RIL_ADAPTER_OEM_INDICATION = 2003;
    const int32_t RIL_ADAPTER_OEM_RESPONSE = 2004;
