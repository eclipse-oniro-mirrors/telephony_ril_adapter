...
HWTEST_F(BranchTest, Telephony_HrilManager_Call_002, Function | MediumTest | Level2)
{
    ...
    EXPECT_NE(HDF_SUCCESS, call->GetCallListResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->DialResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->HangupResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->RejectResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->HoldCallResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->UnHoldCallResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SwitchCallResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->AnswerResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetClipResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetClipResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->CombineConferenceResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SeparateConferenceResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->CallSupplementResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetCallWaitingResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetCallWaitingResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetCallTransferInfoResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetCallTransferInfoResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetCallRestrictionResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetCallRestrictionResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetClirResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetClirResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->StartDtmfResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SendDtmfResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->StopDtmfResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetCallPreferenceModeResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetCallPreferenceModeResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetUssdResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetUssdResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetMuteResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetMuteResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetEmergencyCallListResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->GetCallFailReasonResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetEmergencyCallListResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->SetBarringPasswordResponse(0, responseInfo, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->CallStateUpdated(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->CallUssdNotice(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 1));
    EXPECT_NE(HDF_SUCCESS, call->CallRingbackVoiceNotice(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, call->CallSrvccStatusNotice(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, call->CallEmergencyNotice(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, call->CallSsNotice(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, call->CallRsrvccStatusNotify(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
}
...
HWTEST_F(BranchTest, Telephony_HrilManager_Network_002, Function | MediumTest | Level3)
{
    ...
    HRilRadioResponseInfo responseInfo;
    EXPECT_NE(HDF_SUCCESS, network->GetSignalStrengthResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetCsRegStatusResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetPsRegStatusResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetOperatorInfoResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetNetworkSearchInformationResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetNetworkSelectionModeResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->SetNetworkSelectionModeResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->SetPreferredNetworkResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetPreferredNetworkResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetNeighboringCellInfoListResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetCurrentCellInfoResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->GetPhysicalChannelConfigResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->SetLocateUpdatesResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->SetNotificationFilterResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->SetDeviceStateResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->NetworkCsRegStatusUpdated(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->NetworkPsRegStatusUpdated(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->SignalStrengthUpdated(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->NetworkTimeUpdated(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->NetworkTimeZoneUpdated(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->NetworkPhyChnlCfgUpdated(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, network->NetworkCurrentCellUpdated(0, HRilErrNumber::HRIL_ERR_NULL_POINT, NULL, 0));
}
...
HWTEST_F(BranchTest, Telephony_HrilManager_Sms_002, Function | MediumTest | Level3)
{
    ...
    HRilRadioResponseInfo responseInfo;
    EXPECT_NE(HDF_SUCCESS, sms->SendGsmSmsResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->SendCdmaSmsResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->AddSimMessageResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->DelSimMessageResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->UpdateSimMessageResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->SetSmscAddrResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->GetSmscAddrResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->SetCBConfigResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->GetCBConfigResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->SetCdmaCBConfigResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->GetCdmaCBConfigResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->SendSmsMoreModeResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->SendSmsAckResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->AddCdmaSimMessageResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->DelCdmaSimMessageResponse(0, responseInfo, NULL, 0));
    EXPECT_NE(HDF_SUCCESS, sms->UpdateCdmaSimMessageResponse(0, responseInfo, NULL, 0));
