...
bool HRilSms::CreateCdmaMessageInfo(HRilCdmaSmsMessageInfo &cdmaSmsInfo, const std::string &pdu)
{
    ...
    cdmaSmsInfo.serviceId = std::stol(pdu.substr(0, INT_LEN), nullptr, HEXADECIMAL);
    cdmaSmsInfo.isExist = std::stoi(pdu.substr(INT_LEN + BYTE_LEN * NUM_3, BYTE_LEN), nullptr, HEXADECIMAL);
    cdmaSmsInfo.type = std::stoi(pdu.substr(INT_LEN + INT_LEN, INT_LEN), nullptr, HEXADECIMAL);
    int32_t index = INT_LEN * NUM_3;
    // adress
    cdmaSmsInfo.address.digitMode = std::stol(pdu.substr(index, BYTE_LEN), nullptr, HEXADECIMAL);
    cdmaSmsInfo.address.mode = std::stol(pdu.substr(index + BYTE_LEN, BYTE_LEN), nullptr, HEXADECIMAL);
    cdmaSmsInfo.address.type = std::stol(pdu.substr(index + BYTE_LEN * NUM_2, BYTE_LEN), nullptr, HEXADECIMAL);
    cdmaSmsInfo.address.plan = std::stol(pdu.substr(index + BYTE_LEN * NUM_3, BYTE_LEN), nullptr, HEXADECIMAL);
    cdmaSmsInfo.address.number = std::stol(pdu.substr(index + BYTE_LEN * NUM_4, BYTE_LEN), nullptr, HEXADECIMAL);
    ...
    // subAdress
    cdmaSmsInfo.subAddress.type = std::stol(pdu.substr(index, BYTE_LEN), nullptr, HEXADECIMAL);
    cdmaSmsInfo.subAddress.odd = std::stol(pdu.substr(index + BYTE_LEN, BYTE_LEN), nullptr, HEXADECIMAL);
    cdmaSmsInfo.subAddress.number = std::stol(pdu.substr(index + BYTE_LEN * NUM_2, BYTE_LEN), nullptr, HEXADECIMAL);
...
bool HRilSms::CheckCdmaPduLength(HRilCdmaSmsMessageInfo &cdmaSmsInfo, const std::string &pdu)
{
    ...
    cdmaSmsInfo.address.number = std::stol(pdu.substr(index - BYTE_LEN, BYTE_LEN), nullptr, HEXADECIMAL);
    ...
    // subAdress
    cdmaSmsInfo.subAddress.number = std::stol(pdu.substr(index - BYTE_LEN, BYTE_LEN), nullptr, HEXADECIMAL);
    ...
    // bearer Data
    cdmaSmsInfo.size = std::stol(pdu.substr(index - BYTE_LEN, BYTE_LEN), nullptr, HEXADECIMAL);
