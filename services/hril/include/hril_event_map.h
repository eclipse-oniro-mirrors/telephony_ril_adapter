...
static std::unordered_map<int32_t, std::string> requestEventMap_ = {
    ...
    { HREQ_SIM_GET_PRIMARY_SLOT, "HREQ_SIM_GET_PRIMARY_SLOT" },
    { HREQ_SIM_SET_PRIMARY_SLOT, "HREQ_SIM_SET_PRIMARY_SLOT" },
    ...
    { HREQ_DATA_SEND_UEPOLICY_DECODE_RESULT, "HREQ_DATA_SEND_UEPOLICY_DECODE_RESULT" },
    { HREQ_DATA_SEND_UE_SECTION_IDENTIFIER, "HREQ_DATA_SEND_UE_SECTION_IDENTIFIER" },
    { HREQ_DATA_SEND_IMS_RSD_LIST, "HREQ_DATA_SEND_IMS_RSD_LIST" },
    { HREQ_DATA_SYNC_ALLOWED_NSSAI_WITH_MODEM, "HREQ_DATA_SYNC_ALLOWED_NSSAI_WITH_MODEM" },
    { HREQ_DATA_SYNC_EHPLMN_WITH_MODEM, "HREQ_DATA_SYNC_EHPLMN_WITH_MODEM" },
...
static std::unordered_map<int32_t, std::string> notificationEventMap_ = {
    ...
    { HNOTI_DATA_NETWORKSLICE_URSP_RPT, "HNOTI_DATA_NETWORKSLICE_URSP_RPT"},
    { HNOTI_DATA_NETWORKSLICE_ALLOWED_NSSAI_RPT, "HNOTI_DATA_NETWORKSLICE_ALLOWED_NSSAI_RPT"},
    { HNOTI_DATA_NETWORKSLICE_EHPLMN_RPT, "HNOTI_DATA_NETWORKSLICE_EHPLMN_RPT"},
    ...
    { HNOTI_MODEM_NCFG_FINISHED_RESULT, "HNOTI_MODEM_NCFG_FINISHED_RESULT" },
    { HNOTI_MODEM_RESTART_RILD_NV_MATCH, "HNOTI_MODEM_RESTART_RILD_NV_MATCH" },
};
} // namespace Telephony
} // namespace OHOS
