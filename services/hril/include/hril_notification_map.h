 ...
 */
    ...
    {HNOTI_MODEM_NCFG_FINISHED_RESULT, NEED_LOCK},
    {HNOTI_MODEM_RESTART_RILD_NV_MATCH, NEED_LOCK},

    {HNOTI_DATA_NETWORKSLICE_URSP_RPT, NEED_LOCK},
    {HNOTI_DATA_NETWORKSLICE_ALLOWED_NSSAI_RPT, NEED_LOCK},
    {HNOTI_DATA_NETWORKSLICE_EHPLMN_RPT, NEED_LOCK},
