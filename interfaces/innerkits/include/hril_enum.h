...
typedef enum {
    ...
    HRIL_NETWORK_NR_ONLY = 31, // old --> new  HRIL_NETWORK_NR
    HRIL_NETWORK_NR = 31,
    HRIL_NETWORK_NR_LTE = 32,
    HRIL_NETWORK_NR_LTE_CDMA_EVDO = 33, // old --> new HRIL_NETWORK_NR_LTE_WCDMA
    HRIL_NETWORK_NR_LTE_GSM_WCDMA = 34, // old --> new HRIL_NETWORK_NR_LTE_WCDMA_GSM
    HRIL_NETWORK_NR_LTE_WCDMA_GSM = 34,
    HRIL_NETWORK_NR_LTE_CDMA_EVDO_GSM_WCDMA = 35, // old --> new HRIL_NETWORK_NR_LTE_EVDO_CDMA
    HRIL_NETWORK_NR_LTE_EVDO_CDMA = 35,
    HRIL_NETWORK_NR_LTE_WCDMA = 36, // old --> new HRIL_NETWORK_NR_LTE_WCDMA_GSM_EVDO_CDMA
    ...
    HRIL_NETWORK_NR_LTE_TDSCDMA_GSM_WCDMA = 40, // old --> new HRIL_NETWORK_NR_LTE_TDSCDMA_WCDMA_GSM
    HRIL_NETWORK_NR_LTE_TDSCDMA_WCDMA_GSM = 40,
    HRIL_NETWORK_NR_LTE_TDSCDMA_CDMA_EVDO_GSM_WCDMA = 41, // old-->new HRIL_NETWORK_NR_LTE_TDSCDMA_WCDMA_GSM_EVDO_CDMA
