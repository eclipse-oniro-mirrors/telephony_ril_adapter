...
typedef enum {
    ...
    HREQ_CALL_SET_USSD_CUSD,
    HREQ_CALL_GET_USSD_CUSD,
    HREQ_CALL_SET_CMUT,
    HREQ_CALL_GET_CMUT,
    ...
    HREQ_SIM_SEND_TERMINAL_RESPONSE_CMD,
    HREQ_SIM_SEND_ENVELOPE_CMD,
    HREQ_SIM_STK_CONTROLLER_IS_READY,
    HREQ_SIM_STK_CMD_CALL_SETUP,
    HREQ_SIM_OPEN_LOGICAL_SIM_IO,
    HREQ_SIM_CLOSE_LOGICAL_SIM_IO,
    HREQ_SIM_TRANSMIT_APDU_SIM_IO,
    ...
    HREQ_NETWORK_SET_PS_ATTACH_STATUS,
    HREQ_NETWORK_GET_PS_ATTACH_STATUS,
    HREQ_NETWORK_GET_RADIO_CAPABILITY,
    HREQ_NETWORK_SET_RADIO_CAPABILITY,
