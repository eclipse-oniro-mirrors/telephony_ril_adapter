...
struct SimIoRequestInfo : public Parcelable {
...
struct SimLockInfo : public Parcelable {
    int32_t serial;
...
struct SimPasswordInfo : public Parcelable {
    int32_t serial;
    std::string fac; /* String type, which specifies the object operated by this command.
                      * “SC”：SIM PIN1；
                      * “P2”：SIM PIN2；
...
struct SimPinInputTimes : public Parcelable {
    int32_t serial;
